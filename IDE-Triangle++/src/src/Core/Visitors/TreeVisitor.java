...
public class TreeVisitor implements Visitor {
    ...
    public Object visitForCommand(ForCommand ast, Object o) {
        return (createTernary("For Command", ast.C, ast.E, ast.D));
    }

    @Override
    public Object visitForWhileCommand(ForWhileCommand ast, Object o) {
        return (createQuaternary("For While Command", ast.C, ast.E1, ast.E2, ast.D));
    }
    ...
    public Object visitProcFuncDeclaration(ProcFuncDeclaration ast, Object o) {
        return (createBinary("Proc Func Declaration", ast.D1, ast.D2));
    }
    
    @Override
    public Object visitVarInitializeDeclaration(VarInitializeDeclaration ast, Object obj) {
        return(createBinary("Variable Initialize Declaration", ast.I, ast.E));
    }
    
    @Override
    public Object visitForVarDeclaration(ForVarDeclaration ast, Object arg1) {
        return(createBinary("For Vsr Declaration", ast.I, ast.E));
    }
