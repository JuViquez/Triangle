...
public final class Checker implements Visitor {
  ...
  /* Fin implementación commands agregados */
  ...
  public Object visitParDeclaration(ParDeclaration ast, Object o) {
      ...
      int currentParLevel = idTable.level;
      idTable.state = State.PAR;
      idTable.ParLevel = idTable.level;
      ast.D1.visit(this, null);
      ast.D2.visit(this, null); 
      idTable.state = aux;
      idTable.ParLevel = currentParLevel;
      return null;
  }
  ...
  public Object visitSimpleVname(SimpleVname ast, Object o) {
    ...
    if (binding == null)
      ...
      if (binding instanceof ConstDeclaration) {
        ...
        ast.variable = true;
      } else if (binding instanceof VarInitializeDeclaration) { /* Procesar VarInitializeDeclaration */
        ast.type = ((VarInitializeDeclaration) binding).E.type;
        ast.variable = true;
      } else if (binding instanceof ForVarDeclaration) { /* Procesar ForVarDeclaration */
