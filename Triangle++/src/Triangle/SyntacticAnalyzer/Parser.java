...
import Triangle.AbstractSyntaxTrees.VarInitializeDeclaration;
...
// to represent its phrase structure.
  ...
  Command parseSingleCommand() throws SyntaxError {
    ...
    case Token.REPEAT: //=======Nuevo
      ...
      break;
    case Token.FOR: //=======Nuevo
    {
        acceptIt();
        Declaration dAST = parseForVarDeclaration();
        accept(Token.TO);
        Expression eAST = parseExpression();
        switch (currentToken.kind){
            case Token.DO: 
...
///////////////////////////////////////////////////////////////////////////////
  ...
  Declaration parseDeclaration() throws SyntaxError { //=======Modificacion
    ...
    while (currentToken.kind == Token.SEMICOLON) {
      ...
      declarationAST = new CompoundDeclaration(declarationAST, d2AST,
       declarationPos); 
    }
    return declarationAST;
  }

  Declaration parseCompoundDeclaration() throws SyntaxError{ //=======Nuevo
      Declaration declarationAST = null;
      SourcePosition declarationPos = new SourcePosition();
      start(declarationPos);
      switch(currentToken.kind){
 ...
 Declaration parseProcFuncs() throws SyntaxError{ //=======Nuevo
     Declaration declarationAST = null;
     SourcePosition declarationPos = new SourcePosition();
     start(declarationPos);
     ...
     do{
         ...
         finish(declarationPos);
         declarationAST = new ProcFuncDeclaration(declarationAST, d2AST,declarationPos);
     }while (currentToken.kind == Token.AND);
     
     return declarationAST;
 }
  
  Declaration parseProcFunc() throws SyntaxError{ //=======Nuevo
      Declaration declarationAST = null;
      SourcePosition declarationPos = new SourcePosition();
      start(declarationPos);
      switch (currentToken.kind){
  ...
  Declaration parseSingleDeclaration() throws SyntaxError { //=======Modificacion
    ...
    case Token.VAR:
      {
        ...
        switch(currentToken.kind) {
            ...
            case Token.BECOMES:
            {
                ...
                Expression eAST = parseExpression();
                finish(declarationPos);
                declarationAST = new VarInitializeDeclaration(iAST, eAST, declarationPos);
            }
            break;
        }
      }
  ...
  Declaration parseForVarDeclaration() throws SyntaxError{
      Declaration declarationAST = null; // in case there's a syntactic error
      SourcePosition declarationPos = new SourcePosition();
      start(declarationPos);
      accept(Token.VAR);
      ...
      Expression eAST = parseExpression();
      finish(declarationPos);
      declarationAST = new ForVarDeclaration(iAST, eAST, declarationPos);
      return declarationAST;
  }
